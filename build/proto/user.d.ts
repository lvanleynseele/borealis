...
export interface ProtoGrpcType {
    accountPackage: {
        ...
        AccountService: SubtypeConstructor<typeof grpc.Client, _accountPackage_AccountServiceClient> & {
            service: _accountPackage_AccountServiceDefinition;
        };
    ...
    userPackage: {
        ...
        UserService: SubtypeConstructor<typeof grpc.Client, _userPackage_UserServiceClient> & {
            service: _userPackage_UserServiceDefinition;
        };
    };
}
export {};
